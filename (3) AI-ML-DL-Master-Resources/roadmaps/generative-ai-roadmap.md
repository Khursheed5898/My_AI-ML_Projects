...
> A **complete Core Generative AI roadmap** — from probability distributions to creativity at scale.
...
- [Beginner Level — Generative Modeling Foundations](#beginner-level--generative-modeling-foundations)
  - [Core Concepts](#core-concepts)

- [Intermediate Level — Core Generative AI](#intermediate-level--core-generative-ai)
  - [Core Concepts](#core-concepts-1)
  - [Highly Recommended Resources ⭐](#highly-recommended-resources-)

- [Advanced Level — Modern & Production Generative AI](#advanced-level--modern--production-generative-ai)
  - [Core Concepts (Advanced)](#core-concepts-2)

- [Generative Models & Architectures — Learning Resources](#generative-models--architectures--learning-resources)
...
## Beginner Level — Generative Modeling Foundations
...
|----|---------|----------------------|------------------------|-------|
| 1 | [Deep Learning – Ian Goodfellow](https://www.deeplearningbook.org/) | [3Blue1Brown – Probability](https://www.youtube.com/@3blue1brown) | [DeepLearning.AI – GANs & VAEs](https://www.coursera.org/specializations/generative-adversarial-networks-gans) | Beginner |
| 2 | [Probabilistic Machine Learning – Kevin Murphy](https://probml.github.io/pml-book/) | [StatQuest – Generative Models](https://www.youtube.com/c/joshstarmer) | [MIT 6.S191](https://introtodeeplearning.com/) | Beginner |

---

## Intermediate Level — Core Generative AI
...
| S.No | Best Book | Best YouTube Playlist | Best University Course | Level |
|----|---------|----------------------|------------------------|-------|
| 1 | *Deep Learning* – Goodfellow | [GANs – Ian Goodfellow](https://www.youtube.com/watch?v=AJVyzd0rqdc) | [Stanford CS236](https://deepgenerativemodels.github.io/) | Intermediate |
| 2 | *Dive Into Deep Learning* – Zhang et al. | [Diffusion Models – AssemblyAI](https://www.youtube.com/@AssemblyAI) | [MIT 6.S191](https://introtodeeplearning.com/) | Intermediate |
| 3 | *Probabilistic ML* – Murphy | [Hugging Face Diffusers](https://www.youtube.com/@huggingface) | [Berkeley CS294-158](https://people.eecs.berkeley.edu/~jordan/courses/294-fall09/) | Intermediate |
...
- **Deep Learning (Goodfellow) – Generative Chapters**  
  https://www.deeplearningbook.org/

- **Papers With Code – Generative Models**  
  https://paperswithcode.com/task/generative-modeling

> ❗ *CS236 is the definitive course for understanding modern generative modeling.*

---

## Advanced Level — Modern & Production Generative AI
...
## Generative Models & Architectures — Learning Resources
